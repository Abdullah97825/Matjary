...
export default function NewPromoCodePage() {
    ...
    const onSubmit = async (data: PromoCodeFormData) => {
        try {
            ...
            // Format the data for API to match PromoCodeCreate interface
            const formattedData = {
                code: data.code,
                ...
                userAssignments: [], // Empty array of PromoCodeUserAssignment objects
                excludedUserIds: [] // Empty array for now
            };

            await promoService.createPromoCode(formattedData);
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Set up the general details of your promo code</CardDescription>
                        </CardHeader>
            ...
            <div className="mt-6">
                <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-4 text-sm text-yellow-800">
                    <div className="flex items-center gap-2">
                        ...
                        <p>
                            <strong>Important:</strong> User assignment and exclusion can be managed after creating the promo code by editing it from the promo codes list.
                        </p>
                    </div>
                </div>
            </div>
